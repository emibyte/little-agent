...
schema_get_file_content = types.FunctionDeclaration(
    ...
    description = "Get the contents of a specified file within the working directory.",
    parameters = types.Schema(
        type = types.Type.OBJECT,
        properties = {
            "file_path": types.Schema(
                type = types.Type.STRING,
                description = "The path of the file to get the content of, relative to the working directory.",
            ),
        },
        required = ["file_path"],
    )
